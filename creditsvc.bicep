...
// KEYVAULT NAME -KV
param servkv string = 'NT-Prod-Plat-Credit'  
...
//SUBNET
var subnet_apps = 'NT-Prod-Platform-NET-Partner-SN'
  ...
  tags: {
   ...
   properties: {
    ...
    networkAcls: {
      ...
      virtualNetworkRules: [
        {
          id: '${virtualnetworks_nt_prod_platform_net_vnet_externalid}/subnets/${servkv}'
...
resource webappVnet 'Microsoft.Web/sites/networkConfig@2020-06-01' = {
 parent: appService
  name: 'virtualNetwork'
  properties: {
    subnetResourceId: '${virtualnetworks_nt_prod_platform_net_vnet_externalid}/subnets/${subnet_apps}'
    swiftSupported: true
  }
}
...
resource appservicesetting 'Microsoft.Web/sites/config@2021-03-01' = {
      ...
      parent: appService
        ...
        ipSecurityRestrictions: [
          ...
          {
            vnetSubnetResourceId: '${virtualnetworks_nt_prod_platform_net_vnet_externalid}/subnets/${subnet_apps}'
            action: 'Allow'
            tag: 'Default'
            priority: 200
